  ...
  return (
    <div className="space-y-6 animate-fade-in p-6">
      ...
      <div className="card p-5">
        <div className="mb-3 h-5 w-1/3 animate-shimmer rounded bg-zinc-200 dark:bg-zinc-800" />
        <div className="space-y-3">
          {[1, 2, 3].map((i) => (
            <div key={i} className="flex items-center gap-3">
              <div className="h-6 w-16 animate-shimmer rounded-md bg-zinc-200 dark:bg-zinc-800" />
              <div className="h-4 flex-1 animate-shimmer rounded bg-zinc-200 dark:bg-zinc-800" />
            </div>
          ))}
        </div>
      </div>
