  ...
  const sidebarContent = (
    <>
      <Link
        ...
        className="flex items-center gap-2.5 border-b border-zinc-100 px-3 py-4 transition-colors hover:bg-zinc-50 dark:border-zinc-800 mid:border-[#4f4635] dark:hover:bg-zinc-900 mid:border-[#4f4635] mid:hover:bg-[#3d3627]"
      >
